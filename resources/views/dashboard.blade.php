...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">اهلا بعودتك مرة اخري </h2>
                <p class="mg-b-0">انت الان في لوحة التحكم - برنامج الفواتير </p>
            </div>
        </div>
        <div class="main-dashboard-header-right">
            <div>
                <label class="tx-13">تقييم المشتركين</label>
                <div class="main-star">
            ...
            <div>
                <label class="tx-13">عدد البنوك المشتركة</label>
                <h5 style="text-align: center">{{ \App\Models\Section::count() }}</h5>
            </div>
            <div>
                <label class="tx-13">اجمالي ثمن الفواتير</label>
                <h5>{{number_format(\App\Models\Invoice::sum('Total'), 2)}}</h5>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
...
{{--حساب النسبة المئوية لعدد الفواتير الغير مدفوهة بنسبة للاجمالي الفواتير--}}
                                    @php
