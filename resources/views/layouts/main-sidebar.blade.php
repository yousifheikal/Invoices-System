			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{asset('profile/3135715.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">

                            {{-- Username - Email Auth--}}
							<h4 class="font-weight-semibold mt-3 mb-0">{{ucfirst(username())}}</h4>
							<span class="mb-0 text-muted">{{email()}}</span>
						</div>
					</div>
				</div>
                {{--برنامج الفواتير الي في كل حاجة تخص البرنامج --}}
				<ul class="side-menu">
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('invoices.paid') }}">الفواتير المدفوعه</a></li>
                            @endcan
                            @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('invoices.partial') }}">الفواتير المدفوعه جزئيا</a></li>
                            @endcan
                            @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('invoices.unpaid') }}">الفواتير الغير المدفوعه</a></li>
                            @endcan
                            @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('show.delete') }}">ارشيف الفواتير</a></li>
                            @endcan
                        </ul>
					</li>
                    @endcan
                    @can('التقارير')
					<li class="side-item side-item-category">التقراير</li>
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @endcan
                            @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . $page='customer_report') }}">تقارير العملاء</a></li>
                            @endcan
                        </ul>
					</li>
                    @endcan
