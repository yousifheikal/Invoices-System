            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoices.update', $invoice->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <input type="hidden" class="form-control" id="inputName" name="id" value="{{$invoice->id}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                       value="{{$invoice->Amount_collection}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Value_VAT" name="Value_VAT" value="{{ old('Value_VAT') }}" readonly>
                            </div>
