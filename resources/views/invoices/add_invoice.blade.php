                    ...
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                       value="{{ old('invoice_number') }}"  title="يرجي ادخال رقم الفاتورة" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" value="{{ old('note') }}" rows="3"></textarea>
                            </div>
                        </div><br>
