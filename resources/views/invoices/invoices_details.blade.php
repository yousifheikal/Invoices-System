...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ معلومات عن الفواتير</span>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            ...
            <div class="card" id="tabs-style4">
                <div class="card-body">
                    ...
                    <p class="mg-b-20">اختار المعلومات الذي تريدها </p>
                    <div class="text-wrap">
                        <div class="example">
                            <div class="d-md-flex">
                                <div class="">
                                        ...
                                        <div class="tab-menu-heading">
                                            <div class="tabs-menu ">
                                                ...
                                                <ul class="nav panel-tabs ml-3">
                                                    <li class=""><a href="#tab21" class="active" data-toggle="tab">معلومات الفواتير</a></li>
...
{{--                                                                        <img src="{{ asset('Attachments/'.$attachment->invoice_number.$attachment->file_name) }}" alt="My Image">--}}
