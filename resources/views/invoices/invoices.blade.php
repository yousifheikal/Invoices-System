                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu tx-13">
                                                                <a class="dropdown-item" href="{{route('invoices.edit', $invoice->id)}}"><i
                                                                        class="text-success fas fa-exchange-alt"></i>&nbsp;&nbsp;تعديل</a>

                                                            @endcan
                                                            @can('حذف الفاتورة')
                                                            <a class="modal-effect btn btn-sm" data-effect="effect-scale"
                                                               data-id="{{$invoice->id }}"
                                                               data-toggle="modal" href="#modaldemo9" title="حذف وارشفة الفواتير"><i
                                                                    class="text-danger fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي
                                                                الارشيف</a>
                                                            @endcan
                                                            @can('تغير حالة الدفع')
                                                                <a class="dropdown-item" href="{{route('invoices.show', $invoice->id)}}"><i
                                                                        class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp; تغيير حالة الدفع</a>
