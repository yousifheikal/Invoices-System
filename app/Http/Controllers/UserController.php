...
//            'roles' => 'required',
            ...
            'email.required' => 'يجب ادخال ايميل للمستخدم',
            'email.unique' => 'الايميل موجود بالفعل ',
            'password.required' => 'يجب ادخال كلمة سر للمستخدم ',
//            'roles.required' => 'يجب ادخال صلاحيات للمستخدم ',
            'status.required' => 'يجب ادخال حالة للمستخدم ',
        ]);
        $input = $request->all();
